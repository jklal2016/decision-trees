...
object ExerciseLog{
  ...
  def main(args: Array[String]){
        ...
        val decision_tree = new LogisticRegression()
        ...
        val best_model = cvModel.bestModel.asInstanceOf[PipelineModel].stages.last.asInstanceOf[LogisticRegressionModel]
        ...
        println("Best Max Iter = " + best_model.parent.asInstanceOf[LogisticRegression].getMaxIter)
        ...
        println("Best Reg Param = " + best_model.parent.asInstanceOf[LogisticRegression].getRegParam)
        //.getImpurity for classification and regression
        //.getRegParam for logistic regression
        println("Best Threshold = " + best_model.parent.asInstanceOf[LogisticRegression].getThreshold)
