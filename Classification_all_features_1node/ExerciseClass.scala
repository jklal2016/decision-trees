...
object ExerciseClass{
  ...
  def main(args: Array[String]){
        ...
        // "_c12", "_c13", "_c14", "_c15", "_c16", "_c17", "_c18", "_c19", "_c20", "_c21",
           .setInputCols(Array("_c1", "_c2", "_c3", "_c4", "_c5", "_c6", "_c7", "_c8", "_c9", "_c10", "_c11",
           "_c12", "_c13", "_c14", "_c15", "_c16", "_c17", "_c18", "_c19", "_c20", "_c21",
        ...
        // Create Regression Tree Classifier
        val lr_decision_tree = new DecisionTreeClassifier()
        ...
        val paramGrid = new ParamGridBuilder()
          .addGrid(decision_tree.impurity, Array("entropy", "gini"))
        ...
        //  .addGrid(lr_decision_tree.maxIter, Array(1, 30, 50))
        //  .addGrid(lr_decision_tree.regParam, Array(0.1, 0.5, 1))
        //  .addGrid(lr_decision_tree.threshold, Array(0.25, 0.5, 0.75))
        ...
        val best_model = cvModel.bestModel.asInstanceOf[PipelineModel].stages.last.asInstanceOf[DecisionTreeClassificationModel]
        ...
        println("Best Max Depth = " + best_model.parent.asInstanceOf[DecisionTreeClassifier].getMaxDepth)
        ...
        println("Best Impurity = " + best_model.parent.asInstanceOf[DecisionTreeClassifier].getImpurity)
        //.getImpurity for classification and regression
        //.getRegParam for logistic regression
        println("Best Max Bins = " + best_model.parent.asInstanceOf[DecisionTreeClassifier].getMaxBins)
